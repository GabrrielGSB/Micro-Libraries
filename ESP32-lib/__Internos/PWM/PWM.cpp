...
#pragma region CONSTRUTOR E DESTRUTOR
    PWM::PWM(gpio_num_t numPino, uint32_t freq_hz, ledc_timer_bit_t res_bits) 
        ...
        channel_conf.hpoint         = 0;                  // Ponto de início do ciclo PWM, controle de fase
...
#pragma region MÉTODOS PROTECTED
...
#pragma region MÉTODOS PUBLIC
    ...
    void PWM::habilitarClockCamera(uint32_t frequencia_hz) {
        ...
        uint32_t duty_50_percent = 2; // duty em 50%
